...
TextureShader::TextureShader(ID3D11Device* device, HWND hwnd, LPCSTR shaderfileName, LPCSTR vertexFuncName, LPCSTR pixelFuncName) : Shader(device, hwnd, shaderfileName, vertexFuncName, pixelFuncName)
{
